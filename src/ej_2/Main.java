...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Biblioteca biblioteca = new Biblioteca(libros.length);

        for (int i = 0; i < libros.length; i++) {
            biblioteca.agregarLibro(libros[i]);
        }

        biblioteca.listarLibros();

        System.out.println();
        System.out.println("El libro del índice 5 tiene "
                + libros[5].getCantidadPaginas()
                + " páginas.");

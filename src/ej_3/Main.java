...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Hospital hospital = new Hospital(pacientes.length);

        for (int i = 0; i < pacientes.length; i++) {
            hospital.agregarPaciente(pacientes[i]);
        }
        ...
        System.out.println("Paciente índice 4");
        System.out.println("Edad: " + pacientes[4].getEdad());
        System.out.println("Hospitalizado: " + pacientes[4].isEstaHospitalizado());

        System.out.println();

        System.out.println("Paciente índice 12");
        System.out.println("Edad: " + pacientes[12].getEdad());
        System.out.println("Hospitalizado: " + pacientes[12].isEstaHospitalizado());
